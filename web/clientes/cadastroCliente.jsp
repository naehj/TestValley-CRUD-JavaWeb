    ...
    <div class="container">	
        ...
        <form action='salvar' method="POST">
            ...
            <div class="form-group row">
                ...
                <label for="logradouro" class="col-2 col-form-label">Tipo de Logradouro:</label>
                <div class="col-5">
                    <input class="form-control" type="text" id="tipo_logradouroE" name="tipo_logradouroE" required="true">
                </div>
                <label for="logradouro" class="col-2 col-form-label">Tipo de Residência:</label>
                <div class="col-5">
                    <input class="form-control" type="text" id="tipo_residenciaE" name="tipo_residenciaE" required="true">
                </div>
                <label for="numeroRes" class="col-2 col-form-label">Número:</label>
                <div class="col-2">
